...
export function HomePage({ searchParams }) {
    ...
    const goToSearch = (query) => {
        ...
        navigate(`/papers?page=${searchParams.page}&per_page=${searchParams.per_page}&query=${query}&sort=${searchParams.sorting}`);
    };
...
export function Search({ searchParams }) {
    ...
    const goToSearch = (query) => {
        ...
        navigate(`/papers?page=1&per_page=${searchParams.per_page}&query=${query}&sort=${searchParams.sorting}`);
    };
